...
public class HtmlTest {
	...
	String selectctest ="select * from html";
	String selectans ="select answer from html where qid ='?'";
 ...
 public  boolean getans1(Answer answer,int count1) {
	 ...
	 try {
		...
		Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/exam","root","choubeyraju92&");
		 PreparedStatement ps=con.prepareStatement("select answer from html where qid='"+count1+"' ");
